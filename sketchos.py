...
# calculate position on screen in terminal and make that char black with black 
# background and fix that position (f. e. transpose by one line everytime)
# make a message out of fixed chars like that
